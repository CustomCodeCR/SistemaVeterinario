...
public class GetAllAppointmentByPetHandler : IRequestHandler<GetAllAppointmentByPetQuery, BaseResponse<IEnumerable<AppointmentResponseDto>>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;
    private readonly IOrderingQuery _ordering;

    public GetAllAppointmentByPetHandler(IUnitOfWork unitOfWork, IMapper mapper, IOrderingQuery ordering)
    {
    ...
    public async Task<BaseResponse<IEnumerable<AppointmentResponseDto>>> Handle(GetAllAppointmentByPetQuery request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            appointments = appointments.Where(x => x.Petid.Equals(request.PetId));
